...
const I18N = (() => {
  const dict = {
    th: {
      ...
      density_title: '⚖️ ความหนาแน่นอาหาร', f_weight: 'น้ำหนักตัวอย่าง (g)', f_weight_ph: 'เช่น 100',
      f_volume: 'ปริมาตรภาชนะ (mL)', f_volume_ph: 'เช่น 1000 (ถ้าใช้วิธีถ้วยตวง)',
      density_bulk: 'ความหนาแน่นรวม (Bulk)', density_particle: 'ความหนาแน่นเม็ด',
      density_hint: 'มาตรฐาน: ชั่งตัวอย่าง 10 ก. ใส่ลงภาชนะที่ทราบปริมาตร → Bulk density (g/L) · หรือถ่ายทั้ง 10 ก. ในเฟรมเดียว → วัดปริมาตรเม็ดจากภาพได้ (g/cm³)',
    ...
    vi: {
      ...
      density_title: '⚖️ Mật độ thức ăn', f_weight: 'Khối lượng mẫu (g)', f_weight_ph: 'VD 100',
      f_volume: 'Thể tích cốc (mL)', f_volume_ph: 'VD 1000 (nếu dùng cốc đong)',
      density_bulk: 'Mật độ khối (Bulk)', density_particle: 'Mật độ viên',
      density_hint: 'Chuẩn: cân 10 g cho vào cốc đã biết thể tích → Bulk density (g/L) · hoặc chụp cả 10 g trong 1 khung → đo thể tích viên từ ảnh (g/cm³)',
    ...
    en: {
      ...
      density_title: '⚖️ Feed density', f_weight: 'Sample weight (g)', f_weight_ph: 'e.g. 100',
      f_volume: 'Container volume (mL)', f_volume_ph: 'e.g. 1000 (cup method)',
      density_bulk: 'Bulk density', density_particle: 'Particle density',
      density_hint: 'Standard: weigh 10 g into a known-volume cup → bulk density (g/L) · or photograph the whole 10 g in one frame → image particle density (g/cm³)',
