...
const I18N = (() => {
  const dict = {
    th: {
      ...
      chart_len: 'การกระจายความยาว (ซม.)',
      chart_len_title: 'จำนวนเม็ดตามช่วงความยาว (ซม.)',
      ...
      th_range_cm: 'ช่วง (ซม.)', th_count: 'จำนวน', th_pct: '%',
      ...
      s_bins: 'ขอบช่วงความยาว (ซม. คั่นด้วย , )',
    ...
    vi: {
      ...
      chart_len: 'Phân bố chiều dài (cm)',
      chart_len_title: 'Số viên theo khoảng chiều dài (cm)',
      chart_dia: 'Phân bố đường kính (mm)',
      chart_dia_title: 'Số viên theo khoảng Ø (mm)',
      chart_total: 'Tổng cộng {n} viên',
      dist_title: 'Bảng tỷ lệ',
      th_range_cm: 'Khoảng (cm)', th_count: 'Số lượng', th_pct: '%',
      ...
      s_bins: 'Mốc khoảng chiều dài (cm, cách bằng , )',
      s_polarity: 'Nền ảnh',
    ...
    en: {
      ...
      chart_len: 'Length distribution (cm)',
      chart_len_title: 'Pellet count by length range (cm)',
      ...
      th_range_cm: 'Range (cm)', th_count: 'Count', th_pct: '%',
      ...
      s_bins: 'Length bin edges (cm, comma-separated)',
      ...
      s_demax: 'Color pass threshold (ΔE ≤)',
