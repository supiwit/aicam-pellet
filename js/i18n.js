...
const I18N = (() => {
  const dict = {
    th: {
      ...
      density_hint: 'กรอกน้ำหนัก+ปริมาตรภาชนะ = Bulk density (g/L) · กรอกน้ำหนักอย่างเดียว = ความหนาแน่นเม็ดจากภาพ (g/cm³)',
    ...
    vi: {
      ...
      density_hint: 'Khối lượng + thể tích = Bulk density (g/L) · chỉ khối lượng = mật độ viên từ ảnh (g/cm³)',
    ...
    en: {
      ...
      density_hint: 'Weight + container volume = bulk density (g/L) · weight only = image particle density (g/cm³)',
