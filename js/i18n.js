...
const I18N = (() => {
  const dict = {
    th: {
      ...
      s_refcolor: 'สีมาตรฐาน—กุ้ง', s_userefcolor: 'เปรียบเทียบสีกับสีมาตรฐาน',
      s_demax: 'เกณฑ์สีผ่าน—กุ้ง (ΔE00 ≤)',
      ...
      cal_auto_fail_card: 'ไม่พบบัตร — วางบัตรทั้งใบบนพื้นตัดกับสีบัตร ไม่ให้เม็ดทับ ถ่ายตรงๆ จากด้านบน แล้วลองใหม่',
      blur_warn: 'ภาพอาจไม่คมชัด/เบลอ — วัดขนาดอาจคลาดเคลื่อน โปรดถ่ายใหม่ให้โฟกัสชัด แสงพอ และกล้องนิ่ง',
      ...
      th_product: 'ชนิด',
      nav_learn: 'ความรู้', learn_title: '📚 ความรู้ & หลักการ', learn_intro: 'อธิบายหลักการวัดและคุณภาพอาหารเม็ดอย่างมีหลักวิชาการ — แตะหัวข้อเพื่ออ่าน',
      shape_cyl: 'ทรงกระบอก (Pellet Mill)', shape_round: 'ทรงกลม (Extrusion)',
      stage_label: 'จุดเก็บตัวอย่าง', lock_pick: 'เลือกผู้ใช้แล้วกรอกรหัส', logout_btn: '🚪 ออกจากระบบ',
      cal_color: '🎴 ปรับเทียบสี (การ์ดเทา/ขาว)', cal_color_ok: '✓ ปรับเทียบสีแล้ว', cal_color_fail: 'ภาพมืดเกินไป ลองถ่ายการ์ดเทา/ขาวให้เต็มเฟรม',
      s_webhook: 'Webhook แจ้งเตือน SPC (URL)', s_webhook_ph: 'วาง URL Discord/Slack/อื่นๆ',
      storage_used: 'ใช้ไป {n} รายงาน', storage_left: 'เก็บได้อีกประมาณ {n} ภาพ',
      s_saved_sync: '✓ บันทึก & ซิงค์ทุกเครื่องแล้ว', stage_all: 'ทุกจุด',
      color_range_legend: 'มองไม่ออก ← → ต่างชัด',
      density_title: '⚖️ ความหนาแน่นอาหาร', f_weight: 'น้ำหนักเม็ดในภาพ (g)', f_weight_ph: 'เช่น 10',
      f_volume: 'ปริมาตรภาชนะ (mL) — ไม่บังคับ', f_volume_ph: 'เช่น 1000 (ถ้าใช้วิธีถ้วยตวง)',
      density_bulk: 'ความหนาแน่นรวม (Bulk)', density_particle: 'ความหนาแน่นเม็ด (Particle)',
      density_imgvol: '📐 ปริมาตรเม็ดจากภาพ',
      density_particle_warn: 'ค่าผิดช่วงปกติ — น้ำหนักต้องเป็นของ "เฉพาะเม็ดที่อยู่ในภาพนี้" (ชั่งเม็ดที่จะถ่ายก่อน ~10–20 เม็ด แล้วกรอกน้ำหนักนั้น)',
      density_hint: 'วิธี: ชั่งเฉพาะเม็ดที่จะถ่าย (เริ่ม 10 ก.) → ถ่ายเม็ดชุดนั้นทั้งหมดในเฟรมเดียว → ระบบวัดปริมาตรจากภาพ แล้วคำนวณความหนาแน่นเม็ด (g/cm³) ให้อัตโนมัติ · ถ้าจะหา Bulk density (g/L) ให้กรอกปริมาตรภาชนะด้วย',
      s_refcolor_fish: 'สีมาตรฐาน—ปลา', s_demax_fish: 'เกณฑ์สีผ่าน—ปลา (ΔE00 ≤)',
      s_logo_title: '🖼 โลโก้องค์กร', s_logo_hint: 'อัปโหลดไฟล์โลโก้ (จะแสดงหน้าล็อก/หัวแอป/PDF) ใช้ร่วมทุกเครื่อง',
      s_logo_pick: 'เลือกไฟล์โลโก้', s_logo_clear: 'ลบโลโก้', s_logo_set: '✓ ตั้งโลโก้แล้ว',
    ...
    vi: {
      ...
      s_refcolor: 'Màu chuẩn—Tôm', s_userefcolor: 'So sánh màu với màu chuẩn',
      s_demax: 'Ngưỡng màu—Tôm (ΔE00 ≤)',
      ...
      cal_auto_fail_card: 'Không thấy thẻ — đặt nguyên thẻ trên nền tương phản, không để viên đè lên, chụp thẳng từ trên rồi thử lại',
      blur_warn: 'Ảnh có thể bị mờ/nhòe — kích thước đo có thể sai lệch, hãy chụp lại cho nét, đủ sáng và giữ máy chắc',
      ...
      th_product: 'Loại',
      nav_learn: 'Kiến thức', learn_title: '📚 Kiến thức & nguyên lý', learn_intro: 'Giải thích nguyên lý đo và chất lượng viên — chạm để đọc',
      shape_cyl: 'Hình trụ (Pellet Mill)', shape_round: 'Hình tròn (Ép đùn)',
      stage_label: 'Điểm lấy mẫu', lock_pick: 'Chọn người dùng rồi nhập mã', logout_btn: '🚪 Đăng xuất',
      cal_color: '🎴 Hiệu chuẩn màu (thẻ xám/trắng)', cal_color_ok: '✓ Đã hiệu chuẩn màu', cal_color_fail: 'Ảnh quá tối, chụp thẻ xám/trắng đầy khung',
      s_webhook: 'Webhook cảnh báo SPC (URL)', s_webhook_ph: 'Dán URL Discord/Slack...',
      storage_used: 'Đã dùng {n} báo cáo', storage_left: 'Còn khoảng {n} ảnh',
      s_saved_sync: '✓ Đã lưu & đồng bộ mọi thiết bị', stage_all: 'Tất cả điểm',
      color_range_legend: 'Không thấy ← → Rõ rệt',
      density_title: '⚖️ Mật độ thức ăn', f_weight: 'KL viên trong ảnh (g)', f_weight_ph: 'VD 10',
      f_volume: 'Thể tích cốc (mL) — tùy chọn', f_volume_ph: 'VD 1000 (nếu dùng cốc đong)',
      density_bulk: 'Mật độ khối (Bulk)', density_particle: 'Mật độ viên (Particle)',
      density_imgvol: '📐 Thể tích viên từ ảnh',
      density_particle_warn: 'Giá trị bất thường — khối lượng phải là của "đúng các viên trong ảnh này" (cân ~10–20 viên sẽ chụp, rồi nhập KL đó)',
      density_hint: 'Cách: cân đúng các viên sẽ chụp (bắt đầu 10 g) → chụp toàn bộ các viên đó trong 1 khung → hệ thống đo thể tích từ ảnh và tự tính mật độ viên (g/cm³) · muốn Bulk density (g/L) thì nhập thêm thể tích cốc',
      s_refcolor_fish: 'Màu chuẩn—Cá', s_demax_fish: 'Ngưỡng màu—Cá (ΔE00 ≤)',
      s_logo_title: '🖼 Logo công ty', s_logo_hint: 'Tải logo (hiển thị ở màn khóa/đầu app/PDF) dùng chung mọi thiết bị',
      s_logo_pick: 'Chọn tệp logo', s_logo_clear: 'Xóa logo', s_logo_set: '✓ Đã đặt logo',
    ...
    en: {
      ...
      s_refcolor: 'Standard color—Shrimp', s_userefcolor: 'Compare color to standard',
      s_demax: 'Color threshold—Shrimp (ΔE00 ≤)',
      ...
      cal_auto_fail_card: 'No card found — place the whole card on a contrasting background, no pellets on it, shoot straight from above and retry',
      blur_warn: 'Image may be blurry/out of focus — sizes can be off; retake sharply, with enough light and a steady camera',
      ...
      th_product: 'Type',
      nav_learn: 'Learn', learn_title: '📚 Knowledge & principles', learn_intro: 'Academic explanation of the measurement and quality methods — tap a topic',
      shape_cyl: 'Cylindrical (Pellet Mill)', shape_round: 'Round (Extrusion)',
      stage_label: 'Sample stage', lock_pick: 'Pick a user, then enter PIN', logout_btn: '🚪 Log out',
      cal_color: '🎴 Color calibrate (grey/white card)', cal_color_ok: '✓ Color calibrated', cal_color_fail: 'Image too dark — shoot a grey/white card filling the frame',
      s_webhook: 'SPC alert webhook (URL)', s_webhook_ph: 'Paste a Discord/Slack/other URL',
      storage_used: 'Used {n} reports', storage_left: 'Room for ~{n} more images',
      s_saved_sync: '✓ Saved & synced to all devices', stage_all: 'All stages',
      color_range_legend: 'imperceptible ← → obvious',
      density_title: '⚖️ Feed density', f_weight: 'Weight of pellets in photo (g)', f_weight_ph: 'e.g. 10',
      f_volume: 'Container volume (mL) — optional', f_volume_ph: 'e.g. 1000 (cup method)',
      density_bulk: 'Bulk density', density_particle: 'Particle density',
      density_imgvol: '📐 Pellet volume from image',
      density_particle_warn: 'Out of normal range — the weight must be of the exact pellets in THIS photo (weigh the ~10–20 pellets you will shoot, then enter that weight)',
      density_hint: 'Method: weigh only the pellets you will photograph (start 10 g) → shoot that whole batch in one frame → the app measures volume from the image and computes particle density (g/cm³) automatically · for bulk density (g/L) also enter the container volume',
      s_refcolor_fish: 'Standard color—Fish', s_demax_fish: 'Color threshold—Fish (ΔE00 ≤)',
      s_logo_title: '🖼 Company logo', s_logo_hint: 'Upload a logo (shown on lock/header/PDF) shared across devices',
      s_logo_pick: 'Choose logo file', s_logo_clear: 'Remove logo', s_logo_set: '✓ Logo set',
