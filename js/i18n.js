...
const I18N = (() => {
  const dict = {
    th: {
      ...
      yield_mesh: 'ตะแกรง {u}–{o} มม.', yield_mesh_csv: 'ช่องตะแกรง (undersize–oversize)',
      ...
      machine_caption: 'เครื่องอัดเม็ด (Pellet Mill) — C.P. Vietnam',
    ...
    vi: {
      ...
      yield_mesh: 'Sàng {u}–{o} mm', yield_mesh_csv: 'Cỡ sàng (undersize–oversize)',
      ...
      machine_caption: 'Máy ép viên (Pellet Mill) — C.P. Vietnam',
    ...
    en: {
      ...
      yield_mesh: 'Sieve {u}–{o} mm', yield_mesh_csv: 'Sieve aperture (undersize–oversize)',
      ...
      machine_caption: 'Pellet Mill — C.P. Vietnam',
