...
const I18N = (() => {
  const dict = {
    th: {
      ...
      rejected_note: 'คัดออก {n} ก้อน (เม็ดติดกัน=กรอบส้ม · ชนขอบ/ผิดขนาด=กรอบจาง) — เพื่อความแม่นยำ โปรดเกลี่ยเม็ดไม่ให้ติดกัน',
    ...
    vi: {
      ...
      rejected_note: 'Đã loại {n} khối (viên dính=khung cam · chạm mép/sai cỡ=khung mờ) — hãy rải viên rời nhau để đo chính xác',
    ...
    en: {
      ...
      rejected_note: '{n} excluded (touching=orange · edge/size=faint) — spread pellets apart for accurate measurement',
